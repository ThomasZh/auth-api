...
class SysContactUsDao():
    def insert(self, username, contactInfo, content):
        sql = """INSERT INTO sys_contact_us
                 (username, contactInfo, content)
                 VALUES (%s, %s, %s)"""
        params = (username, contactInfo, content)
    ...
    def select(self,id):
        sql = """SELECT id, username, contactInfo, content, ctime, status
                 FROM sys_contact_us
                 WHERE id=%s"""
        params = (id,)
        logging.debug(sql, *params)
    ...
    def delete(self, id):
        sql = """DELETE FROM sys_contact_us
                 WHERE id=%s"""
        params = (id,)
        logging.debug(sql, *params)
    ...
    def update(self, id, username, contactInfo, content):
        sql = """UPDATE sys_contact_us
                 SET username=%s, contactInfo=%s, content=%s
                 WHERE id=%s"""
        params = (username, contactInfo, content, id)
        logging.debug(sql, *params)
