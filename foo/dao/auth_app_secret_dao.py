...
class AuthAppSecretDao():
    def insert(self, id, appname, appkey, appsecret):
        _dt = timestamp_to_datetime(current_timestamp())
        sql = """INSERT INTO auth_app_secret
                 (id, appname, appkey, appsecret, ctime)
                 VALUES (%s, %s, %s, %s, %s)"""
        params = (id, appname, appkey, appsecret, _dt)
    ...
    def select(self,id):
        sql = """SELECT id, appname, appkey, appsecret, status, ctime, mtime
                 FROM auth_app_secret
                 WHERE id=%s"""
        params = (id,)
        logging.debug(sql, *params)
    ...
    def selectByKey(self,appkey,appsecret):
        sql = """SELECT id, appname, appkey, appsecret, status, ctime, mtime
                 FROM auth_app_secret
                 WHERE appkey=%s
                 AND appsecret=%s"""
    ...
    def delete(self, id):
        sql = """DELETE FROM auth_app_secret
                 WHERE id=%s"""
        params = (id,)
        logging.debug(sql, *params)
    ...
    def update(self, id, appname, appkey, appsecret):
        sql = """UPDATE auth_app_secret
                 SET appname=%s, appkey=%s, appsecret=%s
                 WHERE id=%s"""
        params = (appname, appkey, appsecret, id)
        logging.debug(sql, *params)
