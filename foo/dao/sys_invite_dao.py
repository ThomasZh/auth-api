...
class SysInviteDao():
    def insert(self, id, fromId, fromName, fromAvatar, toId, toName, toAvatar, type, objId, objName, content):
        _dt = timestamp_to_datetime(current_timestamp())
        sql = """INSERT INTO sys_invite
                 (id, fromId, fromName, fromAvatar, toId, toName, toAvatar, type, objId, objName, content, ctime)
                 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"""
        params = (id, fromId, fromName, fromAvatar, toId, toName, toAvatar, type, objId, objName, content, _dt)
    ...
    def select(self,id):
        sql = """SELECT id, fromId, fromName, fromAvatar, toId, toName, toAvatar, ctime, mtime, status, type, objId, objName, content
                 FROM sys_invite
                 WHERE id=%s"""
        params = (id,)
        logging.debug(sql, *params)
    ...
    def update(self, id, fromId, fromName, fromAvatar, toId, toName, toAvatar, type, objId, objName, content):
        sql = """UPDATE sys_invite
                 SET fromId=%s, fromName=%s, fromAvatar=%s, toId=%s, toName=%s, toAvatar=%s, type=%s, objId=%s, objName=%s, content=%s
                 WHERE id=%s"""
        params = (fromId, fromName, fromAvatar, toId, toName, toAvatar, type, objId, objName, content, id)
        logging.debug(sql, *params)
