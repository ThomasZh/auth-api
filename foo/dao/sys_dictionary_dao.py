...
class SysDictionaryDao():
    def insert(self, id, category, seq, value):
        sql = """INSERT INTO sys_dictionary
                 (id, category, seq, value)
                 VALUES (%s, %s, %s, %s)"""
        params = (id, category, seq, value)
    ...
    def select(self,id):
        sql = """SELECT id, category, seq, value
                 FROM sys_dictionary
                 WHERE id=%s"""
        params = (id,)
        logging.debug(sql, *params)
    ...
    def update(self, id, category, seq, value):
        sql = """UPDATE sys_dictionary
                 SET category=%s, seq=%s, value=%s
                 WHERE id=%s"""
        params = (category, seq, value, id)
        logging.debug(sql, *params)
