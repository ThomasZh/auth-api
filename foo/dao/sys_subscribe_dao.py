...
class SysSubscribeDao():
    def insert(self, username, contactInfo):
        sql = """INSERT INTO sys_subscribe
                 (username, contactInfo)
                 VALUES (%s, %s)"""
        params = (username, contactInfo)
    ...
    def select(self,id):
        sql = """SELECT id, username, contactInfo, ctime, status
                 FROM sys_subscribe
                 WHERE id=%s"""
        params = (id,)
        logging.debug(sql, *params)
    ...
    def update(self, id, username, contactInfo):
        sql = """UPDATE sys_subscribe
                 SET username=%s, contactInfo=%s
                 WHERE id=%s"""
        params = (username, contactInfo, id)
        logging.debug(sql, *params)
